...
We already prepared the ABI for the USDC smart contract, you can simply grab it from the repository:

```bash
curl -o abi.json https://raw.githubusercontent.com/bilinearlabs/quixote/refs/heads/main/abi/usdc_abi.json
```
